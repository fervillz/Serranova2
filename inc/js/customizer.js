...
(function ($) {
  ...
  // Serranova hero social youtube
  wp.customize('Serranova_header_social_soundcloud', function (value) {
    value.bind(function (to) {
  ...
  // Serranova hero social youtube
  wp.customize('Serranova_header_social_medium', function (value) {
    value.bind(function (to) {
