...
<a href="#" class="button seethrough large">Contact us</a>',
	...
	// social
	$wp_customize->add_section( 'Serranova_header_social', array(
		'title'    => __( 'Social', 'Serranova' ),
		'priority' => 50,
		'panel'    => 'Serranova_homepage',
	) );
	$wp_customize->add_setting( 'Serranova_header_social_show', array(
		'default'           => 'yes',
		'type'              => 'theme_mod',
		'capability'        => 'edit_theme_options',
		'transport'         => 'postMessage',
	...
	$wp_customize->add_control( 'Serranova_header_social_show', array(
		'label'    => __( 'Show social icons below the hero banner text', 'Serranova' ),
		'section'  => 'Serranova_header_social',
		'settings' => 'Serranova_header_social_show',
		'type'     => 'select',
		'choices'  => array( 'yes' => __( 'Yes', 'Serranova' ), 'no' => __( 'No', 'Serranova' ) ),
	) );

	$wp_customize->add_setting( 'Serranova_header_social_twitter', array(
		'default'           => __( 'http://twitter.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_twitter', array(
		'label'   => __( 'Twitter URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_facebook', array(
		'default'           => __( 'http://facebook.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_facebook', array(
		'label'   => __( 'Facebook URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_pinterest', array(
		'default'           => __( 'http://pinterest.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_pinterest', array(
		'label'   => __( 'Pinterest URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_linkedin', array(
		'default'           => __( 'http://linkedin.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_linkedin', array(
		'label'   => __( 'LinkedIn URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_gplus', array(
		'default'           => __( 'http://plus.google.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_gplus', array(
		'label'   => __( 'Google+ URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_behance', array(
		'default'           => __( 'http://behance.net', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_behance', array(
		'label'   => __( 'Behance URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_dribbble', array(
		'default'           => __( 'http://dribbble.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_dribbble', array(
		'label'   => __( 'Dribbble URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );
	...
	$wp_customize->add_setting( 'Serranova_header_social_flickr', array(
		'default'           => __( 'http://flickr.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_flickr', array(
		'label'   => __( 'Flickr URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_500px', array(
		'default'           => __( 'http://500px.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_500px', array(
		'label'   => __( '500px URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_reddit', array(
		'default'           => __( 'http://reddit.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_reddit', array(
		'label'   => __( 'Reddit URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_wordpress', array(
		'default'           => __( 'http://wordpress.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_wordpress', array(
		'label'   => __( 'Wordpress URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_youtube', array(
		'default'           => __( 'http://youtube.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_youtube', array(
		'label'   => __( 'Youtube URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_soundcloud', array(
		'default'           => __( 'http://soundcloud.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_soundcloud', array(
		'label'   => __( 'Soundcloud URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );

	$wp_customize->add_setting( 'Serranova_header_social_medium', array(
		'default'           => __( 'http://medium.com', 'Serranova' ),
		'sanitize_callback' => 'sanitize_text_field',
		'type'              => 'theme_mod',
		'transport'         => 'postMessage',
	) );
	$wp_customize->add_control( 'Serranova_header_social_medium', array(
		'label'   => __( 'Medium URL', 'Serranova' ),
		'section' => 'Serranova_header_social',
	) );
	// end social
